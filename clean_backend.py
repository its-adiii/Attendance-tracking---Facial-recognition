...
config.read('config_complete.ini')
...
def recognize_face():
    ...
    try:
        ...
        # Use complete face recognition system
...
if __name__ == '__main__':
    try:
        ...
        port = config.getint('WEB_INTERFACE', 'port', fallback=8080)
        debug = config.getboolean('WEB_INTERFACE', 'debug', fallback=False)
